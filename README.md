...
_1/_ Get the sources

```
git clone git@github.com:1024pix/pix-bot.git && cd pix-bot
```

_2/_ Execute the configuration script:

```
npm run configure
```

_3/_ Start the application

```
npm start
```

_4/_ Access the application on http://localhost:3000

_5/_ Develop and add wonderful features!

_6/_ Testing `publish` script
