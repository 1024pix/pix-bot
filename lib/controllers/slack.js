...
module.exports = {
  ...
  createAndDeployPixSiteRelease(request) {
    ...
    return {
      "text": `Commande de déploiement de la release "${payload.text}" pour PIX site en production bien reçue.`
    };
  },
  ...
  createAndDeployPixProRelease(request) {
    ...
    return {
      "text": `Commande de déploiement de la release "${payload.text}" pour PIX pro en production bien reçue.`
    };
  },
